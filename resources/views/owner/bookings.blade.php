            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600">{{ $bookings->where('status', 'completed')->count() }}</p>
                    </div>
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-green-50">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center gap-2">
                    <span class="text-sm text-gray-600 mr-2">Booking Status:</span>
                    ...
                    <button onclick="filterBookings('confirmed')" id="booking-filter-confirmed" class="booking-filter-btn px-3 py-1 rounded-lg text-sm font-medium bg-gray-200 text-gray-700 hover:bg-blue-200 hover:text-blue-800">
                        Confirmed
                    </button>
                    <button onclick="filterBookings('completed')" id="booking-filter-completed" class="booking-filter-btn px-3 py-1 rounded-lg text-sm font-medium bg-gray-200 text-gray-700 hover:bg-green-200 hover:text-green-800">
                        Played
                    </button>
                    <button onclick="filterBookings('cancelled')" id="booking-filter-cancelled" class="booking-filter-btn px-3 py-1 rounded-lg text-sm font-medium bg-gray-200 text-gray-700 hover:bg-red-200 hover:text-red-800">
                        Cancelled
                    </button>
                </div>
            </div>
