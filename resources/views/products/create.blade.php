...
<div class="max-w-4xl mx-auto py-8 px-4">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Create a new product listing for your badminton store</p>
    </div>

    <!-- Enhanced Form -->
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        <form action="{{ route('products.store', absolute: false) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-6 border border-blue-100">
                ...
                @foreach(['Shoes','Clothing','Shuttlecocks','Rackets','Bags','Accessories'] as $cat)
                                <option value="{{ strtolower($cat) }}" {{ old('category') == strtolower($cat) ? 'selected' : '' }}>
                                    {{ $cat }}
                                </option>
                @endforeach
            </select>
                ...
                <div class="space-y-4">
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-purple-400 transition-colors">
                        ...
                        <label for="image" class="cursor-pointer">
                            <span class="text-lg font-semibold text-gray-700">Click to upload image</span>
            ...
            <div class="flex gap-4 pt-6">
                ...
                <button type="submit" 
                        class="flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-xl font-semibold hover:from-green-700 hover:to-blue-700 transition-all transform hover:scale-105 shadow-lg">
