...
<div class="max-w-xl mx-auto py-8">
    ...
    <form action="{{ route('products.store', absolute: false) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow rounded p-6">
        @csrf
        <div class="mb-4">
        ...
        <div class="flex justify-end">
            <a href="{{ route('products.index', absolute: false) }}" class="mr-4 px-4 py-2 bg-gray-200 rounded">Cancel</a>
