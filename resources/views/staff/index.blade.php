        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl shadow-sm border border-blue-100 p-8 mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Manage your staff members and their access to the system.</p>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $staff->where('email_verified_at', '!=', null)->count() }}</p>
                    </div>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('staff.edit', $member) }}" class="text-blue-600 hover:text-blue-900 transition-colors">
