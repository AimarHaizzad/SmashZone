        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                @if($showSeederButtons)
                    <form action="{{ route('seed.past-bookings') }}" method="POST" onsubmit="return confirm('This will generate past booking data for the last 3 months. This may take a few minutes. Continue?');" class="inline-block">
                        @csrf
                        <button type="submit" 
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 flex items-center gap-3">
                        ...
                        Booking Forecast & Predictions
                    </h2>
                    <p class="text-gray-600 mt-2">Predictive analytics based on historical data for the next 7 days to maximize your income</p>
                </div>
