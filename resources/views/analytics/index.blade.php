...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Facility Reports</h1>
                <p class="text-gray-600 mt-2">Revenue, court utilisation, and operational performance metrics</p>
            </div>
